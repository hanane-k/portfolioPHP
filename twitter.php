  ...
  <main class="column center">
    ...
    <section class="flex column center">
      <div class="singlPr flex column center">
        ...
        <p>Une reproduction du site twitter:<br>une réalisation de la page d'acceuil d'un site connu, dont TWITTER, qui respect le maximum la même présentation.<br>Réalisé au sein de ma formation à l'ADEP de Roubaix.</p>
      </div>
    </section>
    <div>
